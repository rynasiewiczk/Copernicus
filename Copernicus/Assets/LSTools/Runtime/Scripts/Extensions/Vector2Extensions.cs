namespace LazySloth.Utilities
{
    ...
    public static class Vector2Extensions
	{
        ...
        public static Vector2[] GetVectorsInFourDirections()
        {
            return new[] { Vector2.left, Vector2.right, Vector2.up, Vector2.down, };
        }
        
        public static Vector2Int[] GetVectorIntsInFourDirections()
        {
            return new[] { Vector2Int.left, Vector2Int.right, Vector2Int.up, Vector2Int.down, };
        }
    }
}
